  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen pb-40 max-w-6xl mx-auto px-6 relative selection:bg-dorado-suave/20">
        ...
        <footer className="mt-32 pt-10 border-t border-dorado-suave/10 text-center opacity-30 pb-20 flex flex-col items-center gap-4">
          <p className="text-xs font-bold text-azul-noche tracking-widest italic">
            Ser · Soberanía · Memoria · Casa común
          </p>
          <div className="flex items-center gap-3 text-[10px] text-azul-noche/60 font-bold italic">
            <span>Bitácora de sueños · v1.5.3-definitiva</span>
            <span className="w-1 h-1 rounded-full bg-dorado-suave"></span>
